...
function AllProjects({setPage}){
    ...
    const media = {
        ...
        gos: [
            {src: "gos/gosMenu.jpg", type: "img"},
            {src: "gos/gosScore.jpg", type: "img"},
            {src: "gos/gosUI.jpg", type: "img"},
    ...
    return(<>
        ...
        <div class="allProjects">
            ...
            <Project title="The Other" media={media.other}>
                <a href="https://rivsastoria.itch.io/the-other" target="_blank" rel="noreferrer">"The Other"</a> entstand 2025 in einer 
                zweitägigen GameJam mit einem Freund.
                <br />
                ...
                wie möglich. So wurden zum Beispiel mehrere Tilemaps zum Aufbau des Levels genutzt, sowie Animationen und Soundeffekte verwendet.<br/>
            ...
            <Project title="Wheel of Fate" media={media.WOF}>
                <a href="https://rivsastoria.itch.io/wheel-of-fate" target="_blank"rel="noreferrer">"Wheel of Fate"</a> wurde ebenfalls 2025 
                im Rahmen eines zweitägigen GameJams mit zwei weiteren Entwicklern erstellt.
                <br />
                ...
                sowie für die Übergänge zwischen den Szenen zuständig. Außerdem
            ...
            <Project title="Goddess of Swing" media={media.gos}>
                <a href="https://store.steampowered.com/app/3244650/Goddess_Of_Swing/" target="_blank" rel="noreferrer">"Goddess of Swing"</a>{" "}
                ist zwischen 2024 und 2025 im Rahmen meines Studiums an der <a href="https://www.hs-mittweida.de/" target="_blank" rel="noreferrer">
                Hochschule Mittweida</a> entstanden. Über 2 Semester haben ca. 60 Studierende gemeinsam an diesem Projekt gearbeitet.
                <br />
            ...
            <Project title="Scent of Serenity" media={media.sos}>
                <a href="https://rivsastoria.itch.io/scent-of-serenity" target="_blank" rel="noreferrer">"Scent of Serenity"</a> wurde 2024
            ...
            <Project title="Dead Lines" media={media.deadlines}>
                <a href="https://rivsastoria.itch.io/dead-lines" target="_blank" rel="noreferrer">"Dead Lines"</a> wurde 2024 in 
                einem zweitägigen Halloween-GameJam erstellt. Das Team bestand hier aus vier Entwicklern.
                <br />
                In diesem 2D Puzzle Adventure muss man seine Kollegen unbemerkt töten, um in der Geisterwelt
                wichtige Aufzeichnungen wiederzufinden.<br />
                Ich war hier für die Menü-Funktionalitäten zuständig, sowie für die Logik, um zwischen der realen und der
